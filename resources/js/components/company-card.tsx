...
export default function CompanyCard({ company }: { company: Company }) {
    return (
        <div className="bg-background p-6 sm:p-4">
            <Link href={`/companies/${company.id}`} className="mx-auto block w-full">
                <Card className="border-gray-light hover:border-orange/20 w-full cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:shadow-xl">
